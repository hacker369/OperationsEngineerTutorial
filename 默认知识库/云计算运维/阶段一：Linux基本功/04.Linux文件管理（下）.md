...
![1737297268868-57aa8752-81d1-4933-82fd-79c11e7f1f5b.png](./img/-IE3wHtbrvcgrICW/1737297268868-57aa8752-81d1-4933-82fd-79c11e7f1f5b-498345.png)
...
<font style="color:rgb(51, 51, 51);">在命令模式下输入冒号:即可进入末行模式，可以在==末行输入命令==来对文件进行查找、替换、保存、退出等操作。</font>
...
![1737297752482-78ef0a2b-b8a3-4c11-ad13-79464c11c7e0.png](./img/-IE3wHtbrvcgrICW/1737297752482-78ef0a2b-b8a3-4c11-ad13-79464c11c7e0-336574.png)
...
![1737299082189-a1e66176-5d16-4456-8f55-bd257c6a6e13.png](./img/-IE3wHtbrvcgrICW/1737299082189-a1e66176-5d16-4456-8f55-bd257c6a6e13-831022.png)
...
![1737299109624-a9cc88cb-2348-4241-a967-053cf8da27a5.png](./img/-IE3wHtbrvcgrICW/1737299109624-a9cc88cb-2348-4241-a967-053cf8da27a5-078092.png)
...
<font style="color:rgb(51, 51, 51);">按键：D （删除之后当前行会变成空白行）</font>
...
# <font style="color:rgb(51, 51, 51);">五、可视化模式</font>
...
<font style="color:rgb(51, 51, 51);">之前说过vim 是vi 的升级版本，其中比较典型的区别就是vim 更加适合coding，因为vim比vi 多一个代码着色的功能，这个功能主要是为程序员提供编程语言升的语法显示效果，如下：</font>
...
![1737366216692-cb54be35-e7e8-4074-8277-9c6e4647dbc4.png](./img/-IE3wHtbrvcgrICW/1737366216692-cb54be35-e7e8-4074-8277-9c6e4647dbc4-278996.png)
...
<font style="color:rgb(51, 51, 51);">① </font><code><font style="color:rgb(51, 51, 51);background-color:rgb(243, 244, 244);">:x</font></code><font style="color:rgb(51, 51, 51);">在文件没有修改的情况下，表示直接退出（等价于:q），在文件修改的情况下表</font>

<font style="color:rgb(51, 51, 51);">示保存并退出（:wq）</font>
...
> 更新: 2025-01-21 13:47:10  
> 原文: <https://www.yuque.com/u41736172/az9urv/ltgkb3k6vg98573v>