...
![1751525359153-683fa1de-cf2d-4973-98a0-3fb6a54e388c.png](./img/Boq01I51YAIPmzzK/1751525359153-683fa1de-cf2d-4973-98a0-3fb6a54e388c-743777.png)

## 目录功能

下图所示的需要记住：

![1752543072181-c62520ff-c36a-4b5e-a4ec-3b6443ff0572.png](./img/Boq01I51YAIPmzzK/1752543072181-c62520ff-c36a-4b5e-a4ec-3b6443ff0572-133494.png)
...
<font style="color:rgb(51, 51, 51);">主要功能：cd 全称 change directory，切换目录（从一个目录跳转到另外一个目录）</font>
...
<font style="color:rgb(51, 51, 51);">案例一：切换到 /usr/local 这个程序目录</font>

```shell
# cd /usr/local
```

<font style="color:rgb(51, 51, 51);">案例二：比如我们当前在 /home/lhp 下，切换到根目录/下</font>
...
> less命令适合查看大文件内容，而且可以通过 ↑↓ 箭头去一行一行的查看；也可以通过 PgUp、PgDn 进行翻页查看。
>
> 按 q 就可以退出查看。quit
>
> 部分同学 PgUp、PgDn 用不了，那就使用：空格-下一页，b-上一页
...
![1737297752482-78ef0a2b-b8a3-4c11-ad13-79464c11c7e0.png](./img/Boq01I51YAIPmzzK/1737297752482-78ef0a2b-b8a3-4c11-ad13-79464c11c7e0-428320.png)
...
<font style="color:rgb(51, 51, 51);">文件保存、退出、查找与替换、显示行号等等。</font>
...
**<font style="color:rgb(51, 51, 51);background-color:#FBDE28;">④ 针对整个文档中的所有关键词进行替换（只要满足条件就进行替换操作）</font>**
...
![1751589761791-6ce3a0cb-66b8-4100-b2d6-059acfb81688.png](./img/Boq01I51YAIPmzzK/1751589761791-6ce3a0cb-66b8-4100-b2d6-059acfb81688-926695.png)
...
![1740930567660-4ad8149d-180c-4dd1-a5a6-afc368cb931f.png](./img/Boq01I51YAIPmzzK/1740930567660-4ad8149d-180c-4dd1-a5a6-afc368cb931f-691343.png)
...
> 注意：如果这个要删除的组中有用户，那么该组是无法删除的！需要先删除组内的用户，再去删除组！
...
<font style="color:rgb(51, 51, 51);">案例：禁止linuxuser账号登录Linux操作系统，让其作为软件使用的用户</font>
...
<font style="color:rgb(119, 119, 119);">退出切换的用户，使用 </font>**<font style="color:rgb(119, 119, 119);">exit</font>**<font style="color:rgb(119, 119, 119);"> 命令。</font>
...
> 更新: 2026-01-30 19:08:44  
> 原文: <https://www.yuque.com/u41736172/az9urv/bbwemkocayvyffnc>